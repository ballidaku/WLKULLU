...
import ballidaku.wlkullu.adapters.ImageAdapter;
import ballidaku.wlkullu.myUtilities.ItemOffsetDecoration;
...
public class GalleryImages extends AppCompatActivity implements View.OnClickListener
{
    Context context;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        textViewTitle.setText("Select Images");
    ...
    private void showPermissionRationaleSnackBar()
    {
                ...
                Snackbar.LENGTH_INDEFINITE).setAction("OK", new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                ActivityCompat.requestPermissions(GalleryImages.this,
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            case R.id.textViewDone:
                ...
                Log.e("AB", "" + selectedItems);

                Intent intent = new Intent();
                intent.putExtra(MyConstants.IMAGES, selectedItems.toString());
